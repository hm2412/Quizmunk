    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz_img', models.ImageField(blank=True, null=True, upload_to='quiz_thumbnail/')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(check=models.Q(models.Q(('guest_access__isnull', True), ('user__isnull', False)), models.Q(('guest_access__isnull', False), ('user__isnull', True)), _connector='OR'), name='user_xor_guest'),
        ),
    ]
